              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select value={accountType} onValueChange={setAccountType}>
                    <SelectTrigger className="h-12 bg-[rgba(15,23,42,0.6)] text-white border border-white/10 focus:ring-2 focus:ring-[var(--accent-teal)] focus:border-[var(--accent-teal)]" data-testid="signup-account-type-select">
